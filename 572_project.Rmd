---
title: "572_project"
author: "Suraj Powar and Prof. Dr. Henri Schurz"
date: '2024-06-18'
...
First we just integrate and plot the function $$I_{a}^{b} (f) = \int_{a}^{b} f(x) dx$$ \newline

Here $$f(x) = x^p, \text{ where p = 0.5}$$

For function taking values from 0 to 5 we have the following
...
Now the 2D plot of the Left Hand Riemann, Mid point Riemann and Right Hand Riemann methods
...
Now the 3D plot of the Left Hand Riemann, Mid point Riemann and Right Hand Riemann methods
...
Plotting the Error Surface of the Left Hand Riemann Quadrature Method in 2D.
...
Plotting the Error Surface of the Left Hand Riemann Quadrature Method in 3D.
